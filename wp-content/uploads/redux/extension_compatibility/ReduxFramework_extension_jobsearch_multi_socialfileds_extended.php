...
class ReduxFramework_extension_jobsearch_multi_socialfileds_extended extends Redux_Extension_Abstract {
    private $c;
    public function __construct( $parent, $path, $ext_class ) {
        $this->c = $parent->extensions['jobsearch_multi_socialfileds'];
