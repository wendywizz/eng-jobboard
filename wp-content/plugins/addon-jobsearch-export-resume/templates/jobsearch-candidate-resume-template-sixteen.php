                        ...
                        <div class="pdf-style17-content-list-inner <?php echo ($key == 0) ? 'first' : '' ?> <?php echo ($x === $length) ? 'last' : '' ?>">
                            ...
                            <div class="pdf-style17-content-list-date">
                                ...
                                <?php if ($experience_prsnt_datefield_val == 'on') { ?>
                                    <div class="pdf-style17-content-list-date-sub"><?php echo ($experience_start_datefield_val != '' ? jobsearch_get_date_year_only($experience_start_datefield_val) : '') . (' - ') . esc_html__('Present', 'jobsearch-resume-export') ?></div>
                                <?php } else { ?>
                                    <div class="pdf-style17-content-list-date-sub"><?php echo ($experience_start_datefield_val != '' ? jobsearch_get_date_year_only($experience_start_datefield_val) : '') . ($experience_end_datefield_val != '' ? ' - ' . jobsearch_get_date_year_only($experience_end_datefield_val) : '') ?></div>
                                <?php } ?>
