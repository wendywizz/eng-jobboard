                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        <div class="pdf-style14-content-list-inner">
                            ...
                            <?php if ($experience_prsnt_datefield_val == 'on') { ?>
                                <div class="pdf-style14-content-list-date"><?php echo ($experience_start_datefield_val != '' ? jobsearch_get_date_year_only($experience_start_datefield_val) : '') . (' - ') . esc_html__('Present', 'jobsearch-resume-export') ?></div>
                            <?php } else { ?>
                                <div class="pdf-style14-content-list-date"><?php echo ($experience_start_datefield_val != '' ? jobsearch_get_date_year_only($experience_start_datefield_val) : '') . ($experience_end_datefield_val != '' ? ' - ' . jobsearch_get_date_year_only($experience_end_datefield_val) : '') ?></div>
                            <?php } ?>
