                            ...
                            if ($edu_start_metaexist) {
                                if ($education_prsnt_datefield_val == 'on') { ?>
                                    <div class="pdf-style11-education-list-sub"><?php echo($exfield) ?>
                                        &nbsp;<span><?php echo ($education_start_datefield_val != '' ? jobsearch_get_date_year_only($education_start_datefield_val) : '') . (' - ') . esc_html__('Present', 'wp-jobsearch') ?></span>
                                    </div>
                                <?php } else { ?>
                                    <div class="pdf-style11-education-list-sub"><?php echo($exfield) ?>
                                        &nbsp;<span><?php echo ($education_start_datefield_val != '' ? jobsearch_get_date_year_only($education_start_datefield_val) : '') . ($education_end_datefield_val != '' ? ' - ' . jobsearch_get_date_year_only($education_end_datefield_val) : '') ?></span>
                                    </div>
                                    <?php
                                }
                            } else { ?>
