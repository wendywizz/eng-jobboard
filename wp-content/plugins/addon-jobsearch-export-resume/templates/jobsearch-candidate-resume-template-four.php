                    ...
                    foreach ($exfield_list as $exfield) {
                        ...
                        <div class="pdf-style5-experience-inner <?php echo ($length == $x) ? 'last' : '' ?>">
                            ...
                            <?php if ($experience_prsnt_datefield_val == 'on') { ?>
                                <div class="pdf-style5-experience-sub"><?php echo ($experience_start_datefield_val != '' ? jobsearch_get_date_year_only($experience_start_datefield_val) : '') . (' - ') . esc_html__('Present', 'jobsearch-resume-export') ?>
                                    <span>/ &nbsp; &nbsp; <?php echo($experience_end_companyfield_val) ?></span></div>
                            <?php } else { ?>
                                <div class="pdf-style5-experience-sub"><?php echo ($experience_start_datefield_val != '' ? jobsearch_get_date_year_only($experience_start_datefield_val) : '') . ($experience_end_datefield_val != '' ? ' - ' . jobsearch_get_date_year_only($experience_end_datefield_val) : '') ?>
                                    <span>/ &nbsp; &nbsp; <?php echo($experience_end_companyfield_val) ?></span></div>
                            <?php } ?>
                        ...
                        <div class="pdf-style5-education-inner">
                            ...
                            if ($edu_start_metaexist) {
                                if ($education_prsnt_datefield_val == 'on') { ?>
                                    <div class="pdf-style5-education-sub"><?php echo ($education_start_datefield_val != '' ? jobsearch_get_date_year_only($education_start_datefield_val) : '') . (' - ') . esc_html__('Present', 'wp-jobsearch') ?></div>
                                <?php } else { ?>
                                    <div class="pdf-style5-education-sub"><?php echo ($education_start_datefield_val != '' ? jobsearch_get_date_year_only($education_start_datefield_val) : '') . ($education_end_datefield_val != '' ? ' - ' . jobsearch_get_date_year_only($education_end_datefield_val) : '') ?></div>
                                    <?php
                                }
                            } else { ?>
