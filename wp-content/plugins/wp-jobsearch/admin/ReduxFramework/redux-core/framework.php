...
if ( ! class_exists( 'ReduxFramework', false ) ) {
	...
	class ReduxFramework {
		...
		public static $_is_plugin = false;  // phpcs:ignore PSR2.Classes.PropertyDeclaration
                ...
                public $redux_sections = array();
                
                public $redux_args = array();
		...
		public function __construct( $sections = array(), $args = array() ) {
                    $this->redux_sections = $sections;
                    $this->redux_args = $args;
                    //add_action('wp_loaded', array($this, 'init_redux_call'), 99);
                    $this->init_redux($sections, $args);
		}
                
                public function init_redux_call() {
                    $sections = $this->redux_sections;
                    $args = $this->redux_args;
                    $this->init_redux($sections, $args);
                }
                
                public function init_redux($sections = array(), $args = array()) {
