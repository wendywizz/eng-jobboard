	...
	$.widget( 'wp.wpColorPicker', $.wp.wpColorPicker, {
		...
		_create: function() {
			...
			if ( self.options.defaultColor ) {
				self.button.addClass( 'wp-picker-default' ).val( 'Select default color' );
				if ( ! _deprecated ) {
					self.button.attr( 'aria-label', 'Clear color' );
				}
			} else {
				self.button.addClass( 'wp-picker-clear' ).val( 'Clear color' );
				if ( ! _deprecated ) {
					self.button.attr( 'aria-label', 'Clear color' );
				}
			}
