                        ...
                        <td align="center" valign="top"><!-- Header -->
                            <table id="template_header" style="background-color: #454545; color: #f1f1f1; -webkit-border-top-left-radius: 6px !important; -webkit-border-top-right-radius: 6px !important; border-top-left-radius: 6px !important; border-top-right-radius: 6px !important; border-bottom: 0; font-family: Arial; font-weight: bold; line-height: 100%; vertical-align: middle;" border="0" width="100%" cellspacing="0" cellpadding="0">
                                <tbody>
                                    <tr>
                                        <td>
                                            <h1 id="logo" style="color: #f1f1f1; margin: 0; padding: 28px 24px; display: block; font-family: Arial; font-size: 30px; font-weight: bold; text-align: center; line-height: 150%;">Job Interview Meeting</h1>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td valign="top">Hi, {candidate_name}, 
                                                            ...
                                                            You have a meeting with <a href="{employer_link}">{employer_name}</a> for the applied job <a href="{job_link}">{job_title}</a>.

                                                            &nbsp;
                                                            <table class="blueTable">
                                                                <thead>
                                                                    <tr>
                                                                        <th style="text-align: center;" colspan="2">Meeting Details</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    <tr>
                                                                        <td>Meeting Date/Time</td>
                                                                        <td>{meeting_date} {meeting_time}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Duration</td>
