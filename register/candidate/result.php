  ...
  <div class="col-lg-6 offset-lg-1">
    <div class="panel-result">
      ...
      <?php elseif ($status === '2') : ?>
        ...
        <p class="desc">รหัสนักศึกษา <?= $_GET['code'] ?> ได้ลงทะเบียนใช้งานไปแล้ว</p>
        <a class="btn btn-primary" href="<?= baseUrl() ?>candidate"><i class="fas fa-chevron-left"></i> ย้อนกลับ</a>
      <?php else : ?>
        <img class="image" src="<?= baseUrl() ?>assets/img/regist-failed.png" />
        <h3 class="title">ลงทะเบียนใช้งานล้มเหลว</h3>
        <p class="desc">เกิดข้อผิดพลาดในการลงทะเบียน</p>
        <a class="btn btn-primary" href="<?= baseUrl() ?>candidate"><i class="fas fa-redo"></i> ลองอีกครั้ง</a>
      <?php endif; ?>
    </div>
  </div>
</div>
